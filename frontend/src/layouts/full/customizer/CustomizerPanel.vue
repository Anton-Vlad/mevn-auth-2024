                ...
                <v-row class="ma-0">
                    <v-col cols="12" class="pa-0">
                        <div class="pa-5 d-flex justify-space-between align-center">
                            ...
                            <div>
                                <v-btn color="error" variant="outlined" size="small" class="mr-2" @click="clearoptions">
                                    Reset </v-btn>
                    ...
                    <v-col cols="12" class="pa-0">
                        ...
                        <v-card-item class="py-5">
                            ...
                            <v-card-text class="pa-0">
                                <v-radio-group v-model="customizer.fontTheme" hide-details class="custom-font">
                                    <v-radio v-for="font in fontFamily" :key="font" :label="font" :value="font"
                                        color="primary" class="mb-5"></v-radio>
                                </v-radio-group>
                            </v-card-text>
                        </v-card-item>
                        <!------------------------------------->
                        ...
                        <div class="d-flex justify-space-between align-center pa-5">
                            ...
                            <div>
                                <v-radio-group class="custom-radio input-radio ma-n2" v-model="customizer.inputBg"
                                    hide-details>
