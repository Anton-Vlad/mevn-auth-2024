                        ...
                        <v-list lines="two" class="py-0">
                            <v-list-item v-for="(revenue, i) in revenues" :key="i" :value="revenue" color="secondary"
                                ...
                                <template v-slot:append>
                                    <div class="bg-lightsuccess rounded-sm rounded-square d-flex align-center justify-center ml-3"
                                        v-if="revenue.price > 145">
                                        <ChevronUpIcon stroke-width="1.5" width="20" class="text-success" />
                                    </div>
                                    <div class="bg-lighterror rounded-sm rounded-square d-flex align-center justify-center ml-3"
                                        v-else>
                                ...
                                <div class="d-inline-flex align-center justify-space-between w-100">
                                    <div>
                                        ...
                                        <span v-if="revenue.price > 145" class="text-success text-subtitle-2">{{
